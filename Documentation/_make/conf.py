# -*- coding: utf-8 -*-
#
# HybridAuth documentation build configuration file, created by
# TYPO3 extension sphinx on Wed, 01 Apr 2015 09:02:29 +0200.
#
...
project = u'HybridAuth'
copyright = u'2015, André Wuttig'
...
htmlhelp_basename = 'px_hybrid_authdoc'
...
latex_documents = [
    ('Index', 'px_hybrid_auth.tex', u'HybridAuth',
...
pdf_documents = [
    ('Index', 'px_hybrid_auth', u'HybridAuth',
     u'André Wuttig'),
]
...
texinfo_documents = [
    ('Index', 'px_hybrid_auth', u'HybridAuth',
     u'André Wuttig', 'HybridAuth', 'One line description of project.',
     'Miscellaneous'),
]
